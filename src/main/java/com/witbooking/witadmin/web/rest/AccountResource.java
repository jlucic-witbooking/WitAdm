...
import com.witbooking.witadmin.domain.*;
import com.witbooking.witadmin.repository.PersistentTokenRepository;
import com.witbooking.witadmin.repository.UserRepository;
import com.witbooking.witadmin.security.AuthoritiesConstants;
import com.witbooking.witadmin.security.SecurityUtils;
import com.witbooking.witadmin.service.MailService;
import com.witbooking.witadmin.service.UserService;
import com.witbooking.witadmin.web.rest.dto.UserDTO;
    ...
    public ResponseEntity<UserDTO> getAccount() {
        ...
        for (AuthorizedEstablishmentUser authorizedEstablishmentUser : user.getAuthorizedEstablishmentUsers()) {
            ...
            for(Permission permission : role.getPermissions()) {
                userRights.add(permission.getName());
            }
