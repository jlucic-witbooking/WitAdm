...
import com.witbooking.witadmin.repository.AuthorizedEstablishmentUserRepository;
...
public class AuthorizedEstablishmentUserResource {
    ...
    @Timed
    public ResponseEntity<AuthorizedEstablishmentUser> create(@RequestBody AuthorizedEstablishmentUser authorizedEstablishmentUser) throws URISyntaxException {
        ...
        if (authorizedEstablishmentUser.getId() != null) {
            return ResponseEntity.badRequest().header("Failure", "A new authorizedEstablishmentUser cannot already have an ID").body(null);
        }
        AuthorizedEstablishmentUser result = authorizedEstablishmentUserRepository.save(authorizedEstablishmentUser);
        return ResponseEntity.created(new URI("/api/authorizedEstablishmentUsers/" + result.getId()))
                .headers(HeaderUtil.createEntityCreationAlert("authorizedEstablishmentUser", result.getId().toString()))
                .body(result);
    }
    ...
    @RequestMapping(value = "/authorizedEstablishmentUsers",
        ...
        produces = MediaType.APPLICATION_JSON_VALUE)
    @Timed
    public ResponseEntity<AuthorizedEstablishmentUser> update(@RequestBody AuthorizedEstablishmentUser authorizedEstablishmentUser) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
                .headers(HeaderUtil.createEntityUpdateAlert("authorizedEstablishmentUser", authorizedEstablishmentUser.getId().toString()))
                .body(result);
    }
    ...
    public ResponseEntity<Void> delete(@PathVariable Long id) {
        ...
        return ResponseEntity.ok().headers(HeaderUtil.createEntityDeletionAlert("authorizedEstablishmentUser", id.toString())).build();
    }
}
