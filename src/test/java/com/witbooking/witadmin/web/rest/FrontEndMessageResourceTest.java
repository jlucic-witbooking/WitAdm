...
public class FrontEndMessageResourceTest {
    ...
    public void setup() {
        ...
        this.restFrontEndMessageMockMvc = MockMvcBuilders.standaloneSetup(frontEndMessageResource).setMessageConverters(jacksonMessageConverter).build();
    }
    ...
    public void checkUsernameIsRequired() throws Exception {
        int databaseSizeBeforeTest = frontEndMessageRepository.findAll().size();
        // set the field null
        ...
        List<FrontEndMessage> frontEndMessages = frontEndMessageRepository.findAll();
        assertThat(frontEndMessages).hasSize(databaseSizeBeforeTest);
    }
