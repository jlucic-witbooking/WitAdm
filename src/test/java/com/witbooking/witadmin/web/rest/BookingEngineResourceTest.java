...
public class BookingEngineResourceTest {
    ...
    public void setup() {
        ...
        this.restBookingEngineMockMvc = MockMvcBuilders.standaloneSetup(bookingEngineResource).setMessageConverters(jacksonMessageConverter).build();
    }
    ...
    public void checkTickerIsRequired() throws Exception {
        int databaseSizeBeforeTest = bookingEngineRepository.findAll().size();
        // set the field null
        ...
        List<BookingEngine> bookingEngines = bookingEngineRepository.findAll();
        assertThat(bookingEngines).hasSize(databaseSizeBeforeTest);
    }
