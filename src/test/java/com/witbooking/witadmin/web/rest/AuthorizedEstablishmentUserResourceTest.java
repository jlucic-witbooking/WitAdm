...
public class AuthorizedEstablishmentUserResourceTest {
    ...
    public void setup() {
        ...
        this.restAuthorizedEstablishmentUserMockMvc = MockMvcBuilders.standaloneSetup(authorizedEstablishmentUserResource).setMessageConverters(jacksonMessageConverter).build();
    }
