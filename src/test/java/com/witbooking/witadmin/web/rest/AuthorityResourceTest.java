...
public class AuthorityResourceTest {
    ...
    public void setup() {
        ...
        this.restAuthorityMockMvc = MockMvcBuilders.standaloneSetup(authorityResource).setMessageConverters(jacksonMessageConverter).build();
    }
    ...
    public void checkNameIsRequired() throws Exception {
        ...
        List<Authority> authoritys = authorityRepository.findAll();
        assertThat(authoritys).hasSize(databaseSizeBeforeTest);
    }
    ...
    public void getAuthority() throws Exception {
        ...
        // Get the authority
        restAuthorityMockMvc.perform(get("/api/authoritys/{name}", authority.getName()))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON))
